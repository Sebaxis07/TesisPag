...
exports.triggerAISummary = exports.deleteMeeting = exports.updateMeeting = exports.getMeetingById = exports.getMeetingsByProject = exports.createMeeting = void 0;
...
const getMeetingsByProject = async (req, res) => {
    try {
        ...
        const meetings = await models_1.Meeting.find({ project: projectId }).sort({ date: -1 });
